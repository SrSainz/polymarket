...
def _clear_runtime_ledger(db: Database) -> None:
    ...
    db.set_bot_state("live_last_reconciled_order_id", "")
    db.set_bot_state("live_last_failed_order_id", "")
    db.set_bot_state("live_last_stale_pending_order_id", "")
    db.set_bot_state("live_last_stale_pending_reason", "")
