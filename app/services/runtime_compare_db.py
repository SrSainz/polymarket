...
def _read_runtime_snapshot(*, db_path: Path, runtime_mode: str, target_slug: str, target_title: str) -> dict:
    ...
    with _connect(db_path) as conn:
        ...
        return {
            ...
            "official_price_source": _bot_state_text(conn, "strategy_official_price_source"),
            "captured_price_to_beat": round(_bot_state_float(conn, "strategy_captured_price_to_beat"), 4),
            "captured_price_source": _bot_state_text(conn, "strategy_captured_price_source"),
            "effective_price_to_beat": round(_bot_state_float(conn, "strategy_effective_price_to_beat"), 4),
            "effective_price_source": _bot_state_text(conn, "strategy_effective_price_source"),
...
def _empty_runtime_snapshot(*, runtime_mode: str, db_path: Path) -> dict:
    return {
        ...
        "official_price_source": "public-gamma-missing",
        "captured_price_to_beat": 0.0,
        "captured_price_source": "",
        "effective_price_to_beat": 0.0,
